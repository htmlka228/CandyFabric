...
insert into supplier (name) values ('Sergey <--> Danila Adapter');
...
insert into roles (user_id, role_name) values (1, 'SHOP_USER');
insert into roles (user_id, role_name) values (2, 'FABRIC_USER');
insert into roles (user_id, role_name) values (3, 'SUPPLIER_USER');
insert into roles (user_id, role_name) values (4, 'ADMIN');